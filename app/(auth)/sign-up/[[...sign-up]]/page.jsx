...
export default function Page() {
  ...
  "
          ...
          <main className="flex items-center justify-center px-6 sm:px-12 lg:col-span-7 xl:col-span-6 min-h-screen overflow-hidden">
            <div className="w-full items-center justify-center max-w-xl lg:max-w-md">
              {/* <h1 className="text-2xl flex font-bold text-gray-900 sm:text-3xl mb-6">Sign up to continue</h1> */}
              <SignUp />
